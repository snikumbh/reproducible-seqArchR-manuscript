...
title: "archR result analysis report for CTSS in Human (150 downstream)"
output: 
...
for condition upstream 50 and downstream 150 flanks.
...
for(sn in sample_names){
    result_dir_path[[sn]] <- file.path(archR_org_results_path, 
                                       paste0(sn, "150_downstream_results"))
}
...
```
## SAMPLE: human_cellGroup_merged
## Directory exists: experiments/results/human/human_cellGroup_merged150_downstream_results
## ℹ Using saved GRanges obj from CAGEr object
## >> preparing features information...		 2023-02-24 14:52:29 
## >> identifying nearest features...		 2023-02-24 14:52:29 
## >> calculating distance from peak to TSS...	 2023-02-24 14:52:30 
## >> assigning genomic annotation...		 2023-02-24 14:52:30 
## >> adding gene annotation...			 2023-02-24 14:52:48
## 'select()' returned 1:many mapping between keys and columns
## >> assigning chromosome lengths			 2023-02-24 14:52:48 
## >> done...					 2023-02-24 14:52:48
```
...
When considering a downstream flank of 150 instead of just 5, the number of 
clusters are drastically fewer in the raw result. 
...
# ## Make further few clusters -- NOt needed
...
sam_foo2 <- plot_dend_arch(arch_plot = sam_foo, fname = fname2, use_ht = 30,
...
## Ordered list lengths: 244 106 317 219 242 105 240 812 606 478 719 783 574 761 178 1071 420 166 588 254 640
## Original list lengths:574 478 761 606 719 1071 588 254 178 783 640 420 244 106 105 219 166 812 240 317 242
