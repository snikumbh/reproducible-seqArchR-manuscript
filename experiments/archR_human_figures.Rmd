...
# devtools::load_all("/mnt/biggley/home/sarvesh/projects/promoter-architectures-all/clustering-promoter-architectures/archR-public/archR")
...
tissueSpecTau <- read_csv(file.path(data_path, "tissueSpecificity_tau", "Tau_score", "Tau_gene_V8.csv"), col_names = TRUE)
