...
#SBATCH -N 1
#SBATCH -J dm6schor
#SBATCH --output=archR_outputlog_drosophila-schor2017_archRv0.1.8_newly_processed_cage_slurm_%j.out
...
Rscript archR-on-drosophila-schor2017.R r-reticulate /mnt/biggley/home/sarvesh/sarvesh_miniconda/bin/python $SLURM_CPUS_PER_TASK
