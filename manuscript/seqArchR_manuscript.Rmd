...
author:
  ...
  - Boris Lenhard:
      ...
      correspondence: true
institute:
  - mrclms: Computational Regulatory Genomics, MRC London Institute of Medical Sciences, London, UK
...
In this study, we present a new method based on non-negative matrix 
factorisation (NMF) and the associated software called seqArchR that 
clusters promoter sequences based on their motifs at near-fixed distances from 
...
region (NFR) spanning the  promoter [@dreos2016influence; @baranasic2022multiomic].
...
@baranasic2022multiomic also reported that the chromatin organisation of 
...
was processed using CAGEr v2.0.2. See 
[this](https://github.com/snikumbh/reproducible-seqArchR-manuscript/blob/main/archR_dm_schor_figures.Rmd) 
Rmarkdown document for more details.
...
These were processed using CAGEr v1.20. See 
[this](https://github.com/snikumbh/reproducible-seqArchR-manuscript/blob/main/archR_zf_nepal_figures.Rmd) 
Rmarkdown document for more details.
...
For this study, data from all cell lines was merged and processed using CAGEr 
v1.20.
...
It is known that dinucleotide profiles of DNA sequences hold more information than mononucleotide profiles.
...
## Method Availability
seqArchR is made available as an R/Bioconductor package with a GNU General 
Public License version 3 (GPL-3).
It can be accessed at: 
[http://www.bioconductor.org/packages/seqArchR](http://www.bioconductor.org/packages/seqArchR)
The website documenting the package is also accessible at 
<https://snikumbh.github.io/seqArchR> and the source code at 
...
Source code for all analyses and figures is available at: 
[https://github.com/snikumbh/reproducible-seqArchR-manuscript](https://github.com/snikumbh/reproducible-seqArchR-manuscript)

## Data Availability
All data for reproducing results in this manuscript is deposited at Zenodo with 
DOI [10.5281/zenodo.7692742](https://doi.org/10.5281/zenodo.7692742)
